...
def parse_args():
    ...
    parser.add_argument(
        "--test_file", type=str, default=None, help="A csv or a json file containing the test data." # from PC
    )
    parser.add_argument(
...
def main():
    ...
    # num_update_steps_per_epoch = math.ceil(len(test_dataset) / args.gradient_accumulation_steps)
    ...
    model, test_dataset = accelerator.prepare(
        model, test_dataset
    )
